...
export default function BottomBar() {
  ...
  const blueGlowStyle = {
    filter: "drop-shadow(0 0 5px rgba(76, 201, 240, 0.8)) drop-shadow(0 0 10px rgba(76, 201, 240, 0.4))",
    color: "inherit"
  };

  // Estilo para el glow dorado (manteniendo el anterior)
  const goldGlowStyle = {
    filter: "drop-shadow(0 0 5px rgba(253, 230, 138, 0.8)) drop-shadow(0 0 10px rgba(253, 230, 138, 0.4))",
    color: "inherit"
  };
  ...
  return (
    <div className="bottom-bar-mobile">
      ...
      <a 
        href="" 
        className="text-[var(--light-blue)] text-xl p-2 rounded-lg hover:bg-[var(--medium-blue)]/50 transition"
      >
      ...
      <a 
        href="#ranking" 
        className="text-yellow-300 text-xl p-2 rounded-lg hover:bg-yellow-700/60 transition"
      >
