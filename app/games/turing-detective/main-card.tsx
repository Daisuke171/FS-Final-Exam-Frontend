...
import CreateRoomModal from "@/components/game/turing-detective/modals/CreateRoomModal";
import { useEffect, useRef, useState } from "react";
import CustomButtonTwo from "@/components/game/turing-detective/buttons/CustomButtonTwo";
import { getTuringSocket } from "@/app/socket";
import CustomTextInput from "@/components/game/turing-detective/inputs/text/CustomTextInput";
...
export default function MainCard() {
  ...
  return (
    <div>
      ...
      >
        <h1 className="text-4xl font-bold text-font">Turing Detective</h1>
        <p className="text-lg text-center text-subtitle">
          Descubre si con quien hablas es una máquina o un humano.
        </p>
          ...
          <div className="flex gap-3 w-full justify-center">
            ...
            >
              <CustomButtonTwo
                ...
                onClick={() => {
                  window.location.href = "/games/turing-detective/rooms";
                }}
                full
              />
            </motion.div>
